...
<body>
                           ...
                           <div class="form-group row">
                              <div class="col-md-6">
                                 <label for="a-classify" class="text-black">상품분류</label> <input
                                    type="text" class="form-control" id="a-classify"
                                    name="a-classify">
                              </div>
                              <div class="col-md-6">
                           ...
                           <div class="form-group row">
                              <div class="col-md-12">
                                 <label for="a-tradename" class="text-black">상품명</label> <input
                                    type="text" class="form-control" id="a-tradename"
                                    name="a-tradename" placeholder="">
                              </div>
                           </div>
                           <div class="form-group row">
                              <div class="col-md-12">
                                 <label for="a-thumbnail" class="text-black">썸네일</label> <input
                                    type="file" class="form-control" id="a-thumbnail"
                                    name="a-thumbnail" placeholder="">
                              </div>
                           </div>
                           <div class="form-group row">
                              <div class="col-md-12">
                           ...
                           <div class="form-group row">
                              <div class="col-md-12">
                                 <label for="a-date" class="text-black">상품등록일</label> <input
                                    type="text" class="form-control" id="a-date" name="a-date"
                                    readonly>
                              </div>
                           </div>
                           <div class="form-group row">
                              <div style="white-space: nowrap; margin-left: 75px;">
                                 <input type="submit" id="cancelBtn"
                                    class="btn btn-sm btn-primary form-control" value="취소">
                                 <input type="submit" id="enrollBtn"
   ...
   <script>
      ...
      $("#cancelBtn").click(function() {
         //location.href = "/admin/itemsManage"
		 //페이징 정보 물고 목록으로 돌아가기
